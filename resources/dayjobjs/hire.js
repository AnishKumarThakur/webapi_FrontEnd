        ...
        $.ajax({
            ...
            success: function(result,status) {
                ...
                $('#userdropdowndetail').append(
                    ...
                    '                      <div class="image-pad" >\n' +
                    '                        <img class="card-img-top-lg-5" src="file:///home/anish/Documents/Sell%20and%20Buy%20Web%20Api/backend/uploads/'+image+'"\n' +
    ...
    $.ajax({
        ...
        success:function(result,status){
            ...
            for (key in result){
                ...
                append('   <tr >\n' +
                    '                <td align="center">\n' +
                    '                  <img src="file:///home/anish/Documents/Sell%20and%20Buy%20Web%20Api/backend/uploads/'+result[key].image +'" alt="worker image" height="100px" width="140px"></td>\n' +
